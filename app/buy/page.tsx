                ...
                <div style={{ textAlign: 'center', marginBottom: '5rem', maxWidth: '900px', margin: '0 auto 5rem' }}>
                    ...
                    >
                        ...
                        <p style={{
                            ...
                            Discover homes that define elegance. Choose a category below to potentialize your lifestyle.
                        </p>
                    </motion.div>
                </div>
                        ...
                        {propertyTypes.map((type) => {
                            ...
                            return (
                                <motion.div key={type} variants={item}>
                                    <Link href={`/properties-search?type=${encodeURIComponent(type)}&listtype=SELL`} style={{ textDecoration: 'none' }}>
                                            ...
                                            >
                                                ...
                                                <div style={{
                                                    ...
                                                    <h3 style={{
                                                        ...
                                                        marginBottom: '0.5rem',
                                                        letterSpacing: '0.5px',
                                                        textAlign: 'left' // Ensure left align as per design or center if needed? User said "middle" for page title, but here it's card.
                                                        // Wait, user said "Property for sale... in the middle" (Page Title).
                                                        // User said "Office, Hotel... these all things... bigger in size... smaller".
                                                        // This refers to the CARD titles.
                                                        // Previous size was 1.75rem. I'll make it 1.5rem fixed.
                                                    }}>
